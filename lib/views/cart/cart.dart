                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return CartProductCard(
                              banner_image:
                                  Image.memory(cartProducts[index].image),
                              title: cartProducts[index].title,
                              size: sizeChart[cartProducts[index].qtyType],
                              price:
                                  "Rs " + cartProducts[index].price.toString(),
                              quantity: cartProducts[index].quantity.toString(),
                              onDelete: () {
                                context.read<CartBloc>().add(DeleteCartItem(
                                    cartProdId: cartProducts[index].id));
                              },
                              onIncrement: () {
                                context.read<CartBloc>().add(IncrementCartItem(
                                    cartProdId: cartProducts[index].id));
                              },
                              onDecrement: () {},
                            );
